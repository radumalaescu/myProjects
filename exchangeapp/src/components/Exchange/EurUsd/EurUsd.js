    ...
    <div className={styles.EurUsd}>
      <div>
        ...
        <input
          ...
          disabled={isDisabled}
          value={eurUsdValue}
          onChange={changeValueEurUsd}
        ></input>{" "}
      </div>
      <button id={styles.switch} onClick={clickDisableEurUsd}>
        ↓↑
      </button>
      <div>
      ...
      <button id={styles.convert} onClick={updateBallanceErrorEurUsd}>
        Convert
      </button>
    </div>
  );
