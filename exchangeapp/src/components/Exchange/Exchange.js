...
const Exchange = ({ updateBallanceErrorRonEur, updateBallanceErrorRonUsd, changeValueRonEur, changeValueEurRon, clickDisableRonEur,
    ...
    hideErrorBallance, changeValueRonUsd, changeValueUsdRon, ronUsdValue, usdRonValue, changeValueRonGbp, changeValueGbpRon,
    ronGbpValue, gbpRonValue, clickDisableRonGbp, gbpBallance, updateBallanceErrorRonGbp, eurUsdValue, usdEurValue,
    changeValueEurUsd, changeValueUsdEur, clickDisableEurUsd, updateBallanceErrorEurUsd, changeValueEurGbp, changeValueGbpEur,
    eurGbpValue, gbpEurValue, updateBallanceErrorEurGbp, clickDisableEurGbp, changeValueUsdGbp, changeValueGbpUsd, usdGbpValue,
    gbpUsdValue, clickDisableUsdGbp, updateBallanceErrorUsdGbp }) => {
    ...
    return (
        <Router>
            <div className={styles.Exchange}>
                <ul>
                    <li><Link to='/' ref={ronEurRef}>RON - EUR</Link></li>
                    <li><Link to='/ron-usd'>RON - USD</Link></li>
                    <li><Link to='/ron-gbp'>RON - GBP</Link></li>
                    <li><Link to='/eur-usd'>EUR - USD</Link></li>
                    <li><Link to='/eur-gbp'>EUR - GBP</Link></li>
                    <li><Link to='/usd-gbp'>USD - GBP</Link></li>
                </ul>
                <Switch>
                    <Route path='/ron-usd'>
                        <RonUsd
