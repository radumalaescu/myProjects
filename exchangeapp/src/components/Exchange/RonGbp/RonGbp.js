    ...
    <div className={styles.RonGbp}>
      <div>
        ...
        <input
          ...
          disabled={isDisabled}
          value={ronGbpValue}
          onChange={changeValueRonGbp}
        ></input>{" "}
      </div>
      <button id={styles.switch} onClick={clickDisableRonGbp}>
        ↓↑
      </button>
      <div>
      ...
      <button id={styles.convert} onClick={updateBallanceErrorRonGbp}>
        Convert
      </button>
    </div>
  );
